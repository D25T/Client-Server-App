...
void Dialog::onSokDisplayError(QAbstractSocket::SocketError socketError)
{
    ...
    case QAbstractSocket::ConnectionRefusedError:
        QMessageBox::information(this, "Error", "The connection failed");
        break;
    default:
...
void Dialog::onSokReadyRead()
{
    ...
    switch (command)
    {
        case MyClient::comAutchSuccess:
        {
            ...
            AddToLog("Enter as "+_name,Qt::black);
        }
        break;
        case MyClient::comUsersOnline:
        {
            AddToLog("Received user list "+_name,Qt::black);
            ui->pbSend->setEnabled(true);
            QString users;
            in >> users;
            if (users == "")
        ...
        case MyClient::comPublicServerMessage:
        {
            QString message;
            in >> message;
            AddToLog("[PublicServerMessage]: "+message, Qt::black);
        }
        break;
        ...
        case MyClient::comMessageToUsers:
        {
            ...
            QString message;
            in >> message;
            AddToLog("["+user+"](private): "+message, Qt::black);
        }
        break;
        case MyClient::comPrivateServerMessage:
        {
            QString message;
            in >> message;
            AddToLog("[PrivateServerMessage]: "+message, Qt::black);
        }
        break;
...
void Dialog::onSokConnected()
{
    ...
    _blockSize = 0;
    AddToLog("Connected to"+_sok->peerAddress().toString()+":"+QString::number(_sok->peerPort()),Qt::black);
...
void Dialog::onSokDisconnected()
{
    ...
    ui->lwUsers->clear();
    AddToLog("Disconnected from"+_sok->peerAddress().toString()+":"+QString::number(_sok->peerPort()), Qt::black);
}
